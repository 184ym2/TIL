...
namespace CSharpDuplicateObjectsSample.ValueTypes
{
    ...
    {
        /// <summary>
        /// 組み込み型メンバを持つ構造体<see cref="SampleStruct"/>をシャローコピーで複製します。<br/>
        ...
        public static void ShallowCopy()
        {
            ...
            #region  代入で複製-----------------------------------------------------------------
            var orig = new SampleStruct(10, "AAA", new[] { 1, 2, 3 }, new[] { "A", "B", "C" });
            ...
            var orig2 = new SampleStruct(10, "AAA", new[] { 1, 2, 3 }, new[] { "A", "B", "C" });

            Console.WriteLine("\r\n2. コピーコンストラクタ");
            var copy2 = new SampleStruct(orig2);
            ...
            var orig3 = new SampleStruct(10, "AAA", new[] { 1, 2, 3 }, new[] { "A", "B", "C" });
        ...
        /// <summary>
        /// クラスと構造体をメンバを持つ構造体<see cref="SampleStruct2"/>をシャローコピーで複製します。<br/>
        /// 複製には代入、コピーコンストラクタ、MemberwiseCloneメソッドを使用します。
        /// </summary>
        public static void ShallowCopy2()
        {
            ...
            Console.WriteLine("\r\n2. コピーコンストラクタ");
            var copy2 = new SampleStruct2(orig2);
